...
-- 7. Show the countries that are big by area or big by population. Show name, 
-- population and area.
...
-- 9. For South America show population in millions and GDP in billions both 
-- to 2 decimal places.
...
SELECT name
  FROM world
  WHERE name LIKE '%a%' AND name LIKE '%e%' AND name LIKE '%i%' AND 
